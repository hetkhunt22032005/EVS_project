...
<body>
    <form action="AD_Login" method="post">
        ...
        <input type="text" id="ad_username" name="ad_username"  placeholder="Admin Username" required required/><br/>

        
        <input type="password" id="ad_password" name="ad_password"  placeholder="Admin Password" required required/><br/>
