...
<head>
    ...
    <title>Welcome to Green-Whale!</title>
    <style>
        body {
            ...
            align-items: center;
            height: 100vh;
            background-image: url('images/nature.jpg'); /* Replace 'your_background_image.jpg' with your image path */
...
<body>
    <div class="container">
        <h1>Welcome To Green Horizon</h1>
         
        <ul>
            <li><a href="login.jsp" class="button">Login</a></li>
            <li><a href="pladge.jsp" class="button">Registration</a></li>
        </ul>
    </div>
</body>
</html>
